...
class ServiceRecordDetailScreen extends StatefulWidget {
  static const routeName = '/service-record-detail';

  const ServiceRecordDetailScreen({super.key});

  @override
  State<ServiceRecordDetailScreen> createState() => _ServiceRecordDetailScreenState();
}
...
class _ServiceRecordDetailScreenState extends State<ServiceRecordDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: MainScaffold(
        showBackButton: true,
        title: _isEditMode ? 'Service Record Detail' : 'Service Record',
